        ...
        <div class="card">
          ...
          <div>
            <el-row>
              ...
              <!-- 搜索框 -->
              <el-col :span="14" class="paddingLeft138">
                <div class="search">
                  <input class="search_input" type="text">
                  <button class="btn-search el-icon-search"></button>
                  <!-- <img class="search" src="./../assets/images/search.png" alt> -->
                </div>

                <ul class="ul1">
                  <li>
                    <a href="javasrcipt:void(0)" class="ff5">热门搜索 :</a>
                  </li>
                  <li>
          ...
          <div>
            ...
            <ul class="meus_ul">
              <li>
								<router-link to="/nav/about">关于我们</router-link>
              </li>
              <li>
                培训课程
              </li>
              ...
              <li>
               <router-link to="/nav/talkme">联系我们</router-link>
              </li>
            </ul>
          </div>
        </div>
